...
public interface AdminAPI {
    ...
    Response add_award(@SessionAttribute("userContext") UserContext userContext);
    ...
    Response edit_user(String user_email, @SessionAttribute("userContext") UserContext userContext);
