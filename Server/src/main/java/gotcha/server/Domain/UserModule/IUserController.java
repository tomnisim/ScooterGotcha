...
public interface IUserController extends Observable {
    ...
    Boolean register(String userEmail, String password, String phoneNumber, LocalDate birthDay, String gender, String scooterType, LocalDate licenceIssueDate, String raspberryPiSerialNumber, String firstName, String lastName) throws Exception;
    void login(String userEmail, String password) throws Exception;
    void logout(String userEmail) throws UserNotFoundException;
    void appoint_new_admin(String newAdminEmail, String password, String phoneNumber, LocalDate birthDay, String gender, String firstName, String lastName, String appointingAdminEmail) throws Exception;
    ...
    List<String> view_admins(String userEmail) throws Exception;
    ...
    void delete_user(String userEmail, String user_email) throws Exception;
    void update_user_rate(String user_id, Ride ride, int number_of_rides) throws Exception;

    void send_message_to_all_users(String message, String adminEmail) throws Exception;
}
